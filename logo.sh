...
echo "  ${GR}                      ==[ Coded by : Young Professional Terminal(YPT)"
echo "   ${RED}                     ==[ Version : 1.0.0"
echo "  ${GR}                      ==[ Program Type :Bash,PHP,"
echo "  ${GR}                      ==[ I Am Myanmer Young Hacker😉😉😉"
echo "  ${GR}                      ==[ www.github.com/T-Tools"                 
echo "  ${GR}                      ==[ https://www.facebook.com/101466121360286"
echo ""
